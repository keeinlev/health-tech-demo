...
class SignUpForm(forms.Form):
    ...
    ohip_version = forms.CharField(label=False, max_length=2, required=True, widget=forms.TextInput(attrs={'type':"text", 'class':"formcontrol ohip-inputs", 'id':"ohip-version", 'maxlength':"2", 'placeholder':"OHIP Version*", 'style':'text-transform: uppercase'}))
