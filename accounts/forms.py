...
class SignUpForm(forms.Form):
    ...
    phone = forms.CharField(label=False, required=True, max_length=15, widget=forms.TextInput(attrs={'type': "text", 'class': "formcontrol phone-input", 'id': "phone", 'placeholder':"Phone Number", 'autocomplete':'password', 'onkeypress':"if (this.value.length < 14) {return (event.charCode >= 48 && event.charCode <= 57)} else {return false}"}))
