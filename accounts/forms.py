...
class SignUpForm(forms.Form):
    username = forms.CharField(label=False, max_length=50, required=True, widget=forms.TextInput(attrs={'type': "text", 'class': "formcontrol req", 'placeholder': "Username*"}))
    first_name = forms.CharField(label=False, max_length=30, required=True, widget=forms.TextInput(attrs={'type': "text", 'id': "first_name", 'class': "formcontrol req", 'placeholder': "First name*"}))
    preferred_name = forms.CharField(label=False, required=False, max_length=30, widget=forms.TextInput(attrs={'type': "text", 'id': "preferred_name", 'class': "formcontrol", 'placeholder': "Preferred name"}))
    last_name = forms.CharField(label=False, max_length=30, required=True, widget=forms.TextInput(attrs={'type': "text", 'id': "last_name", 'class': "formcontrol req", 'placeholder': "Last name*"}))
    dob = forms.DateField(label=False, required=True, widget=forms.DateInput(attrs={'type': "text", 'class': "formcontrol req", 'id': "dob", 'placeholder': "Date of Birth*", "onfocus": "(this.type='date')", "onblur": "(this.value ? this.type='date' : this.type='text')", 'max':"9999-12-31"}))
    email1 = forms.EmailField(label=False, required=False, max_length=254, widget=forms.TextInput(attrs={'class': 'formcontrol email-inputs req', 'maxlength': '50', 'placeholder': 'Email*', 'id':'email1', 'aria-describedby': 'email-match-help'}))
    email2 = forms.EmailField(label=False, required=False, max_length=254, widget=forms.TextInput(attrs={'class': 'formcontrol email-inputs req', 'maxlength': '50', 'placeholder': 'Confirm Email*', 'id':'email2'}))
    password1 = forms.CharField(label=False, widget=forms.PasswordInput(attrs={'class': 'formcontrol pass-inputs req', 'placeholder': 'Password*', 'id':'password1', 'aria-describedby': 'password-match-help'}), required=True)
    password2 = forms.CharField(label=False, widget=forms.PasswordInput(attrs={'class': 'formcontrol pass-inputs req', 'placeholder': 'Confirm Password*', 'id':'password2'}), required=True)
    phone = forms.IntegerField(label=False, required=False, widget=forms.NumberInput(attrs={'type': "number", 'min':'0', 'onkeypress':"if (this.value.length < 10) {return event.charCode >= 48} else {return false}", 'class': "formcontrol req", 'id': "phone", 'max': "9999999999", 'placeholder': "Phone Number*"}))
    ...
    ohip = forms.IntegerField(label=False, required=True, widget=forms.NumberInput(attrs={'type': "number", 'min':'0', 'onkeypress':"if (this.value.length < 10) {return event.charCode >= 48} else {return false}", 'class': "formcontrol req", 'id': "ohip", 'max': "9999999999", 'placeholder': "OHIP Number*"}))
    ...
    ohip_version = forms.CharField(label=False, max_length=2, required=True, widget=forms.TextInput(attrs={'type':"text", 'class':"formcontrol ohip-inputs req", 'id':"ohip-version", 'maxlength':"2", 'placeholder':"OHIP Version*", 'style':'text-transform: uppercase'}))
    ohip_expiry = forms.DateField(label=False, required=True, widget=forms.DateInput(attrs={'type': "text", 'class': "formcontrol req", 'id': "ohip-expiry", 'placeholder': "OHIP Expiry Date*", "onfocus": "(this.type='date')", "onblur": "(this.value ? this.type='date' : this.type='text')", 'max':"9999-12-31"}))
